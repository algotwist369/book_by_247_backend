    ...
    html: `
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f9f9f9; padding: 40px 20px;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); overflow: hidden;">
                <!-- Header -->
                <div style="background-color: #B20000; color: #ffffff; padding: 25px; text-align: center;">
                ...
                <div style="padding: 40px 30px; color: #444444; line-height: 1.6;">
                    <div style="display: flex; align-items: center; margin-bottom: 20px;">
                        <span style="background-color: #B20000; color: white; padding: 4px 10px; border-radius: 4px; font-size: 12px; font-weight: bold; text-transform: uppercase;">New Inquiry</span>
                    </div>
                    
                    <h2 style="color: #2c3e50; margin-top: 0; font-size: 20px;">New customer inquiry received</h2>
                    <p style="margin-bottom: 25px;">A potential customer has submitted an inquiry through the portal for your <strong>{{branchName}}</strong> branch.</p>
                    ...
                    <div style="background-color: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; padding: 20px; margin-bottom: 30px;">
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td style="padding: 10px 0; color: #7f8c8d; font-size: 14px; width: 120px; border-bottom: 1px solid #eeeeee;">Customer Name</td>
                                <td style="padding: 10px 0; font-weight: 600; color: #2c3e50; border-bottom: 1px solid #eeeeee;">{{customerName}}</td>
                            </tr>
                            <tr>
                                <td style="padding: 10px 0; color: #7f8c8d; font-size: 14px; border-bottom: 1px solid #eeeeee;">Phone Number</td>
                                <td style="padding: 10px 0; font-weight: 600; color: #2c3e50; border-bottom: 1px solid #eeeeee;">{{customerPhone}}</td>
                            </tr>
                            <tr>
                                <td style="padding: 10px 0; color: #7f8c8d; font-size: 14px; border-bottom: 1px solid #eeeeee;">Inquiry Type</td>
                                <td style="padding: 10px 0; font-weight: 600; color: #2c3e50; border-bottom: 1px solid #eeeeee;">{{inquiryType}}</td>
                            </tr>
                            <tr>
                                <td style="padding: 10px 0; color: #7f8c8d; font-size: 14px;">Submitted On</td>
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <a href="{{actionUrl}}" style="background-color: #B20000; color: #ffffff; text-decoration: none; padding: 12px 25px; border-radius: 4px; font-weight: bold; display: inline-block;">View on Dashboard</a>
                    </div>
                </div>
                
                <!-- Footer -->
                <div style="background-color: #f1f2f6; padding: 20px; text-align: center; color: #95a5a6; font-size: 12px;">
                    <p style="margin: 0;">&copy; {{year}} {{businessName}} CRM System.</p>
                </div>
            </div>
        </div>
    `
